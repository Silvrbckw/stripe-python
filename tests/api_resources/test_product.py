...
class TestProduct(object):
    ...
    def test_is_retrievable(self, request_mock):
        ...
        request_mock.assert_requested("get", f"/v1/products/{TEST_RESOURCE_ID}")
    ...
    def test_is_saveable(self, request_mock):
        ...
        resource.save()
        request_mock.assert_requested("post", f"/v1/products/{TEST_RESOURCE_ID}")
    ...
    def test_is_deletable(self, request_mock):
        resource = stripe.Product.retrieve(TEST_RESOURCE_ID)
        resource.delete()
        request_mock.assert_requested("delete", f"/v1/products/{TEST_RESOURCE_ID}")
