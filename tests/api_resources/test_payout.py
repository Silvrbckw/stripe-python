...
class TestPayout(object):
    ...
    def test_is_retrievable(self, request_mock):
        ...
        request_mock.assert_requested("get", f"/v1/payouts/{TEST_RESOURCE_ID}")
    ...
    def test_is_saveable(self, request_mock):
        ...
        resource.save()
        request_mock.assert_requested("post", f"/v1/payouts/{TEST_RESOURCE_ID}")
    ...
    def test_can_cancel(self, request_mock):
        ...
        request_mock.assert_requested("post", f"/v1/payouts/{TEST_RESOURCE_ID}/cancel")
        assert isinstance(resource, stripe.Payout)
    ...
    def test_can_reverse(self, request_mock):
        ...
        request_mock.assert_requested(
            "post", f"/v1/payouts/{TEST_RESOURCE_ID}/reverse"
        )
        assert isinstance(resource, stripe.Payout)
