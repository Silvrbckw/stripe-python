...
class TestSource(object):
    def test_is_retrievable(self, request_mock):
        ...
        request_mock.assert_requested("get", f"/v1/sources/{TEST_RESOURCE_ID}")
    ...
    def test_is_saveable(self, request_mock):
        ...
        resource.save()
        request_mock.assert_requested("post", f"/v1/sources/{TEST_RESOURCE_ID}")
    ...
    def test_is_verifiable(self, request_mock):
        ...
        assert source is resource
        request_mock.assert_requested(
            "post", f"/v1/sources/{TEST_RESOURCE_ID}/verify", {"values": [1, 2]}
        )
...
class TestSourceTransactions(object):
    def test_is_listable(self, request_mock):
        ...
        request_mock.assert_requested(
            "get", f"/v1/sources/{TEST_RESOURCE_ID}/source_transactions"
        )
